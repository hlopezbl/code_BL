...
![MICROBIT drive](/docs/static/mb/device/windows-microbit-drive.png)
...
![](/docs/static/mb/device/details-txt.jpg)
 or **Interface Version: \.\.\.**
 ![](/docs/static/mb/device/details-243.png)
<br/>
...
![MAINTENANCE gesture](/docs/static/mb/device/maintenance.gif)
